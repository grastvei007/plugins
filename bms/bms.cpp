    ...
    while(!stream.atEnd() && !stream.hasError())
    {
        ...
        if(token == QXmlStreamReader::StartElement)
        {
            ...
            if(stream.name() == QString("utotal"))
            {
                ...
                {
					voltageTag_ = tagList()->createTag(subSystem(), "voltage", TagType::eDouble, value, false);
                }
            }
            else if(stream.name() == QString("ucell1")) //>3.28</ucell1>
            {
                ...
                {
					cell1_ = tagList()->createTag(subSystem(), "cell 1", TagType::eDouble, v, false);
                }
            }
            else if(stream.name() == QString("ucell2")) //>3.29</ucell2>
            {
                ...
                {
					cell2_ = tagList()->createTag(subSystem(), "cell 2", TagType::eDouble, v, false);
                }
            ...
            else if(stream.name() == QString("ucell3")) // >3.29</ucell3>
            {
                ...
                {
					cell3_ = tagList()->createTag(subSystem(), "cell 3", TagType::eDouble, v, false);
                }
            ...
            else if(stream.name() == QString("ucell4")) // >3.28</ucell4>
            {
                ...
                {
					cell4_ = tagList()->createTag(subSystem(), "cell 4", TagType::eDouble, v, false);
                }
            ...
            else if(stream.name() == QString("ucell5")) // >N/A</ucell5>
            {
                ...
                {
					cell5_ = tagList()->createTag(subSystem(), "cell 5", TagType::eDouble, v, false);
                }
            ...
            else if(stream.name() == QString("ucell6")) //>N/A</ucell6>
            {
                ...
                {
					cell6_ = tagList()->createTag(subSystem(), "cell 6", TagType::eDouble, v, false);
                }
            ...
            else if(stream.name() == QString("ucell7")) //>N/A</ucell7>
            {
                ...
                {
					cell7_ = tagList()->createTag(subSystem(), "cell 7", TagType::eDouble, v, false);
                }
            ...
            else if(stream.name() == QString("ucell8")) //>N/A</ucell8>
            {
                ...
                {
					cell8_ = tagList()->createTag(subSystem(), "cell 8", TagType::eDouble, v, false);
                }
            ...
            else if(stream.name() == QString("trimmer-0")) //>2.80</trimmer-0>
            {
                ...
                if(trimmer0_)
					...
					trimmer0_ = tagList()->createTag(subSystem(), "trimmer 0", TagType::eDouble, v, false);
            ...
            else if(stream.name() == QString("trimmer-1")) // >3.60</trimmer-1>
            {
                ...
                if(trimmer1_)
					...
					trimmer1_ = tagList()->createTag(subSystem(), "trimmer 1", TagType::eDouble, v, false);
            ...
            else if(stream.name() == QString("UMINset")) //>2800</UMINset>
            {
                ...
                if(uMinCell_)
					...
					uMinCell_ = tagList()->createTag(subSystem(), "uMinCell", TagType::eDouble, v, false);
            }
            else if(stream.name() == QString("UMAXset")) //>3600</UMAXset>
            {
                ...
                if(uMaxCell_)
					...
					uMaxCell_ = tagList()->createTag(subSystem(), "uMaxCell", TagType::eDouble, v, false);
            ...
            else if(stream.name() == QString("UmincellID")) //>1</UmincellID>
            {
                ...
                if(uMinCellId_)
					...
					uMinCellId_ = tagList()->createTag(subSystem(), "min voltage cell id", TagType::eInt, v, false);
            }
            else if(stream.name() == QString("UmaxcellID")) //>3</UmaxcellID>
            {
                ...
                if(uMaxCellId_)
					...
					uMaxCellId_ = tagList()->createTag(subSystem(), "max voltage cell id", TagType::eInt, false);
            }
            else if(stream.name() == QString("Udiff")) //>0.01</Udiff>
            {
                ...
                if(uDiff_)
					...
					uDiff_ = tagList()->createTag(subSystem(), "difference min max cell", TagType::eDouble, v, false);
            }
...
void Bms::setupTags()
{
	cellMinSet_ = tagList()->createTag(subSystem(), "configUMinCell", TagType::eDouble, false);
	cellMaxSet_ = tagList()->createTag(subSystem(), "configUMaxCell", TagType::eDouble, false);
}
